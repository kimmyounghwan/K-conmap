...
TABS = [
    ...
    ("/naeyeok", "산출내역서 작성 대행 — 설계변경 내역 · 실행내역 | K-건설맵",
     "공공 공사 산출내역서를 대신 만들어 드립니다. 100억원 미만은 낙찰자가 착공신고 때, 100억원 이상은 입찰서와 함께 냅니다(국가계약법 시행령 제14조 제6항). 원가계산서·일위대가·단가대비표까지 한 벌. 값은 문의.",
     ("산출내역서 작성해 드립니다", "설계변경 내역 · 실행내역", "검수 후 결제",
      "낙찰되셨습니까? 착공신고 때 산출내역서를 내셔야 합니다")),
...
def main():
    ...
    tab_body = {
        ...
        "/analysis": (lead_card("발주기관 · 업체 낙찰 분석",
                      ...
                      + c_ag + c_co),
        "/naeyeok": lead_card("산출내역서 작성해 드립니다", [
            ...
            "드리는 것: 산출내역서 · 일위대가 · 원가계산서 · 단가대비표 · 공종별 집계표 · 설계변경 내역. "
