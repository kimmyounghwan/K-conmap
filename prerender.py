...
TABS = [
    ...
    ("/shareone", "쉐어원 — 사무실 공유폴더 무료 프로그램 | K-건설맵",
     ...
     ("쉐어원", "사무실 공유폴더", "무료",
      "깔고 · 넣고 · 더블클릭 — 이 셋뿐입니다")),
    ("/safety", "안전관리계획서 · 유해위험방지계획서 — 우리 현장이 대상인가 | K-건설맵",
     ...
     "무슨 자료를 주셔야 하는지, 무엇은 별도 의뢰인지도 적어 두었습니다. 지금은 준비 중입니다.",
     ("안전관리계획서 · 유해위험방지계획서", "우리 현장이 대상인가", "준비 중",
      "착공 전에 내야 하는 법정 계획서 — 대상 기준부터 보십시오")),
...
def main():
    ...
    tab_body = {
        ...
        "/safety": lead_card("안전관리계획서 · 유해위험방지계획서 — 우리 현장이 대상인가", [
            ...
            "유해·위험방지계획서는 검토자 서명이 문서 안에 들어갑니다. 한국산업안전보건공단에 내고 "
            "접수 서식의 처리기간은 15일이라, 착공일에서 거꾸로 세어 일정을 잡아야 합니다. "
            "지금은 준비 중이라 문의 창구를 열지 않았습니다.",
        ]),
