...
def main():
    ...
    tab_body = {
        ...
        "/how": lead_card("K-건설맵 보는 방법", [
            ...
            "만들어 두면 저절로 도는 것은 아낌없이 드립니다 — 바로투찰(권장 투찰금액) · "
            "개찰 결과(1순위) · 마감 전 공고 · 건설 서식 · 설계변경 엑셀 · 캐드 유틸 · 게시판. "
            "한 분이 더 쓴다고 드는 돈이 없으니 막을 이유가 없습니다.",
            "사람 손이 들어가는 것만 돈을 받습니다 — 내역서와 견적서를 대신 써 드리는 일 하나입니다.",
