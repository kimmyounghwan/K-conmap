...
SITENAV = [("/", "바로투찰"), ("/first", "1순위 개찰"), ("/live", "입찰 공고"),
           ...
           ("/analysis", "낙찰 분석"), ("/report", "업체 입찰 성적표"),
           ("/daily", "개찰 성적표"),
...
STATIC_NEW = ["/change", "/change/naeyeok", "/change/excel", "/change/twoline", "/forms", "/guide",
              "/cad", "/naeyeok", "/qna", "/how", "/report", "/jeoksan", "/jeoksan/run",
...
TABS = [
    ...
    ("/report", "업체 입찰 성적표 — 3년치 개찰로 «넣은 것 전부» 를 봅니다 | K-건설맵",
     "낙찰한 것만 보는 자가진단과 달리, 3년치 개찰에서 그 업체가 넣은 것을 전부 찾아 A4 한 벌로 "
     "만들어 드립니다. 왜 떨어졌는지(실격인지 밀린 것인지) · 어느 «분위»에 걸고 있는지 · "
     "투찰 버릇 · 다음에 겨눌 자리 · 놓친 자리 · 그때 바로투찰 금액이었다면 몇 위였을지. "
     "값은 받지 않습니다.",
     ("업체 입찰 성적표", "떨어진 것까지 봅니다", "무료",
      "넣은 것 전부를 3년치에서 찾아 A4 한 벌로")),
    ...
    ("/jeoksan/run", "수량산출서 만들기 — 재료표·치수표에서 엑셀 다섯 장 | K-건설맵",
     ...
     "파일은 브라우저 안에서만 다룹니다. 지금은 열쇠말을 받으신 분만 쓰실 수 있고, "
     "무엇이 나오는지는 열쇠말 없이 보실 수 있습니다.",
     ("수량산출서 만들기", "재료표 + 치수표 → 엑셀 다섯 장", "열쇠말 필요",
      "무엇이 나오는지는 누구나 보실 수 있습니다")),
