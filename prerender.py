...
SITENAV = [("/", "바로투찰"), ("/first", "1순위 개찰"), ("/live", "입찰 공고"),
           ...
           ("/lic", "면허별 경쟁도"),
           ("/cad", "캐드 유틸"), ("/jeoksan", "K-적산"),
           ("/shareone", "쉐어원 공유폴더"),
           ("/safety", "안전관리계획서"),
           ("/naeyeok", "견적서·내역서 작성"), ("/qna", "묻고 답하기"),
           ("/how", "보는 방법")]
...
TABS = [
    ...
    ("/jeoksan/run", "수량산출서 만들기 — 엑셀로 바로 받습니다 | K-건설맵",
     ...
     "파일은 브라우저 안에서만 다루고 도면(.dxf)은 받지 않습니다. 재료표·치수표 견본도 있습니다.",
     ("수량산출서 만들기", "재료표 + 치수표 → 엑셀", "무료",
      "올라가는 것 없이 브라우저 안에서 셉니다")),
    ...
    ("/qna", "입찰 묻고 답하기 — 내역서·설계변경·적격심사 | K-건설맵",
     "공공 입찰·산출내역서·설계변경에서 막히는 것을 묻고 답하는 곳입니다. 회원가입 없이 바로 쓰고, 답은 하루 안에 달아 드립니다.",
     ("묻고 답하기", "입찰·내역서·설계변경", "회원가입 없음",
      "현장에서 막히는 것을 물어보세요")),
...
def main():
    ...
    tab_body = {
        ...
        "/report": lead_card("업체 입찰 성적표", [
            ...
            "보태 주신 분부터 만들어 드립니다. 신청은 묻고 답하기에 「성적표 신청」과 업체명을 "
            "한 줄 남기시면 됩니다.",
            "성적표는 지나간 기록을 정리한 것입니다 — 다음 입찰을 맞히는 것이 아닙니다.",
        ]),
        "/qna": lead_card("입찰 묻고 답하기", [
            "공공 입찰·산출내역서·설계변경에서 막히는 것을 묻는 곳입니다. "
            "회원가입 없습니다. 글 쓸 때 정한 4자리 숫자로 내 글만 지울 수 있습니다.",
            "공사 규모·발주처·지금 어디까지 진행됐는지를 적어 주시면 답이 정확합니다. "
            "공개 게시판이니 전화번호·이메일은 적지 마십시오.",
            "답변은 누구나 달 수 있고, K-건설맵이 단 답에는 「K-건설맵 답변」 표가 붙습니다. "
            "표가 없는 답은 이용자 의견이니 중요한 건은 발주처에 확인하십시오.",
        ]),
