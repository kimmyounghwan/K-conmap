...
def change_twoline(shell, image=None):
    ...
    out = ['<div class="card"><h1 style="font-size:18px;font-weight:800;margin:0">'
           ...
           '<a class="btn ghost" href="/qna">💬 현장 이야기</a></div></div>']
    ld = ld_graph(ld_crumbs(("K-건설맵", None), ("설계변경", "/change"),
...
TABS = [
    ...
    ("/qna", "현장 이야기 — 입찰·내역서·설계변경 묻고 답하기 | K-건설맵",
     "공공 입찰·산출내역서·설계변경 — 궁금한 것도, 겪은 것도, 알려 주고 싶은 것도 아무 말이나 쓰는 게시판입니다. 회원가입 없이 바로 쓰고, 물으신 것은 하루 안에 답을 달아 드립니다.",
     ("현장 이야기", "입찰·내역서·설계변경", "가입 없음",
      "아무 말이나 쓰셔도 됩니다")),
...
def main():
    ...
    tab_body = {
        ...
        "/report": lead_card("업체 입찰 성적표", [
            ...
            "보태 주신 분부터 만들어 드립니다. 신청은 현장 이야기에 「성적표 신청」과 업체명을 "
            "한 줄 남기시면 됩니다.",
            "성적표는 지나간 기록을 정리한 것입니다 — 다음 입찰을 맞히는 것이 아닙니다.",
        ]),
        "/qna": lead_card("현장 이야기", [
            "궁금한 것 · 겪은 것 · 알려 주고 싶은 것 — 아무 말이나 쓰시면 됩니다. "
