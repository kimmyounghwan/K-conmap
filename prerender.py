...
STATIC_NEW = ["/change", "/change/naeyeok", "/change/excel", "/change/twoline", "/forms", "/guide",
              "/cad", "/naeyeok", "/qna", "/how", "/report", "/jeoksan", "/safety",
              "/shareone"] + [
...
TABS = [
    ...
    ("/jeoksan", "K-적산 — 캐드 도면에서 물량을 뽑아 수량산출서를 만듭니다 | K-건설맵",
     "캐드에서 부재를 찍으면 길이·면적을 재고, PC 에서 수량산출서 엑셀(산출서·집계·태그별·검산)을 "
     "만듭니다. 산출식이 프로그램 안이 아니라 엑셀 재료표에 있어 토목·건축 둘 다 되고, 산출근거가 "
     "엑셀에서 살아 있는 수식이라 감리가 칸을 눌러 봅니다. 순수 AutoLISP 이라 AutoCAD LT 2024 이상·"
     "캐디안·ZWCAD 에서도 돕니다. 지금은 준비 중입니다.",
     ("K-적산", "도면에서 물량 뽑기", "준비 중",
      "캐드에서 찍고 PC 에서 셉니다 — 산출식은 엑셀 표에")),
