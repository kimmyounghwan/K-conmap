...
console.log('① 서식·도구 — 하나 받을 때마다 (소장님 규칙)')
T('첫 번째는 뜬다', 띄울까('forms'), true)
T('같은 순간에 또 부르면 안 뜬다 (한 번 누른 게 두 번 세지는 것만 막음)', 띄울까('forms'), false)
/* 🚨 2026-09-17 — 여기가 2분이었습니다. 서식 두세 장 받는 시간이라
   사실상 「받을 때마다」 가 아니라 「2분에 한 번」 이었습니다. 15초로 줄였습니다. */
뒤로('forms', 20 * 1000)
T('20초 뒤에 다음 장을 받으면 «다시 뜬다»', 띄울까('forms'), true)
뒤로('forms', 40 * 1000)
T('그 다음 장도 뜬다', 띄울까('forms'), true)
뒤로('forms', 3 * 60 * 1000)
T('3분 뒤에도 뜬다', 띄울까('forms'), true)
