...
const 사흘 = 3 * 하루
/* 🚨 2026-09-17 — **2분** 이었습니다. 소장님: 「서식 내려받기 해보는데 딱 한 번만 뜨는데,
   글쓰기 그냥 안쓰면 다른거 다운 받아도 더 이상 안떠」
   그 2분이 범인이었습니다. 소장님이 정하신 규칙은 «서식은 하나 다운 받을 때마다» 인데,
   제가 「한 자리에서 연달아 받는 건 한 번으로 본다」 고 임의로 넓혀 놨습니다.
   ⚠️ 2분이면 **서식 두세 장 받는 시간** 입니다. 사실상 「받을 때마다」 가 아니라
      「2분에 한 번」 이 돼 있었습니다.
   → 15초로 줄입니다. 이건 «한 번 누른 것이 두 번 세지는 것» 만 막는 길이입니다
     (내려받기 단추 한 번에 이벤트가 두 번 붙는 경우). 진짜로 다음 장을 받으면 다시 뜹니다. */
const 묶음 = 15 * 1000
...
function 띄울까(kind) {
  ...
  /* 한 번 누른 것이 두 번 세지는 것만 막습니다 (15초) — «받을 때마다» 는 그대로입니다 */
