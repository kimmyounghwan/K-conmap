    ...
    <>
      ...
      <div className="card">
        ...
        <ul className="flist">
          ...
          <li><b>시트끼리 줄을 짝지어 줍니다.</b> 원가계산서가 <code>=내역서!G9</code>로 합계를 끌어올 때,
            <b>두 시트를 같이 고르면</b> 당초 줄은 내역서의 당초 합계를, 변경 줄은 변경 합계를 보게 고칩니다.
            고르지 않은 시트는 손대지 않습니다.</li>
      ...
      <div className="card">
        ...
        <ul className="flist">
          ...
          <li><b>원가계산서가 내역서 합계를 끌어온다면 두 시트를 «같이» 고르십시오.</b>{' '}
