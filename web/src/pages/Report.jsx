    ...
    <>
      ...
      <div className="card">
        ...
        <ul className="flist">
          ...
          <li><b>어느 «분위»에 걸고 있나</b> — 분위는 <b>그 금액이 실격을 면할 확률</b>입니다.
            40분위에 걸었다면 «열 번 중 여섯 번은 하한선 아래로 떨어질 자리»에 낸 것입니다.
            평소 거는 자리와, 그 자리가 실제로 낳은 결과(실격·낙찰)를 칸별로 갈라 봅니다</li>
      ...
      <div className="card">
        ...
        <ul className="flist">
          ...
          {/* 🚨 2026-09-18 — 「3년치에서 넣은 것 전부」 라고 적어 두었는데 아직 사실이 아닙니다.
              떨어진 기록(투찰업체 목록)은 최근치부터 쌓이고 있고, 그 앞 3년치는 1순위만 있습니다.
              메우기가 채우는 만큼 늘어납니다(8절 53). 없는 정확도를 주장하지 않습니다. */}
          <li><b>떨어진 기록은 최근치부터 쌓입니다.</b> 지금은 최근 두 달 남짓의 개찰에서
            «넣은 것 전부»가 다 있고, 그보다 앞은 <b>1순위(낙찰)부터 차례로 메우는 중</b>입니다.
            받으시는 성적표 첫 장에 <b>어느 기간을 본 것인지</b> 적어 드립니다.</li>
          <li>한 개찰에서 조달청이 주는 투찰업체는 <b>낮은 금액 순 30곳</b>까지입니다.
            참가가 그보다 많은 자리에서 <b>30위 밖으로 높게 쓰신 건은 잡히지 않습니다.</b></li>
