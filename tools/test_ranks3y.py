...
def corps(n, base=1000):
    """[[업체명, 금액, 율, ...], ...] — 낮은 금액 순"""
    return [["업체%02d" % i, base + i, 90.0 + i / 100.0, "", ""] for i in range(1, n + 1)]
...
def main():
    ...
    try:
        ...
        eq(m["A001"]["r"][0][1], "업체01", "1순위 이름")
        eq(m["A001"]["r"][2][2], 1003, "3순위 금액")
