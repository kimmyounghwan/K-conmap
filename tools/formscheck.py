...
MASTER = {
 ...
 "공무": [
   ...
   ("공사원가계산서", "wonga"), ("일위대가표", "ilwidaega"),
   ("공사 산출내역서", "sanchul-naeyeok"), ("수량산출서", "suryang"),
   ("설계변경 총괄표", "chg-chongwal"),
 ...
 "품질": [
   ...
   ("말뚝·파일기초 검측 체크리스트", "geomcheuk-malttuk"),
   ("PSC빔·강교 검측 체크리스트", "geomcheuk-psc-gang"),
   ("콘크리트공 검측 체크리스트", "geomcheuk-concrete"),
   ("배수공 검측 체크리스트", "geomcheuk-baesu"),
   ("부대공 검측 체크리스트", "geomcheuk-budae"),
   ("포장공 검측 체크리스트", "geomcheuk-pojang"),
